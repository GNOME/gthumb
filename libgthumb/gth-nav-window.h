...
typedef struct _GthNavWindowPrivateData   GthNavWindowPrivateData;

struct _GthNavWindow {
	GtkHBox __parent;
	GthNavWindowPrivateData *priv;
};
...
GtkWidget *  gth_nav_window_new      (GthIViewer *viewer);

#endif /* _GTH_NAV_WINDOW_H */
