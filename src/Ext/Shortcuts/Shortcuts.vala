public class Gth.Shortcuts {
	...
	public void register_all () {
		...
		register ("app.preferences", N_("Preferences"), SHORTCUT_CONTEXT_BROWSER_VIEWER, ShortcutCategory.GENERAL, "<Primary>comma");
		...
		register ("win.rename-files", N_("Rename"), SHORTCUT_CONTEXT_BROWSER_VIEWER, ShortcutCategory.FILE_MANAGER, "F2");
		...
		register ("win.delete-files-from-disk", N_("Delete Files"), SHORTCUT_CONTEXT_BROWSER_VIEWER, ShortcutCategory.FILE_MANAGER, "<Shift>Delete");
		register ("win.edit-metadata", N_("Edit Comment"), SHORTCUT_CONTEXT_BROWSER_VIEWER, ShortcutCategory.FILE_MANAGER, "c");
		register ("win.print", N_("Print"), SHORTCUT_CONTEXT_BROWSER_VIEWER, ShortcutCategory.FILE_MANAGER, "<Primary>p");
		...
		register ("win.import-files", N_("Import Files"), SHORTCUT_CONTEXT_BROWSER_VIEWER, ShortcutCategory.FILE_MANAGER);
		...
		register ("image.zoom-in-fast", N_("Zoom In Fast"), SHORTCUT_CONTEXT_IMAGE, ShortcutCategory.VIEWER, "<Alt>plus");
		register ("image.zoom-out-fast", N_("Zoom Out Fast"), SHORTCUT_CONTEXT_IMAGE, ShortcutCategory.VIEWER, "<Alt>minus");
		register ("image.set-zoom('100')", N_("Zoom 100%"), SHORTCUT_CONTEXT_IMAGE, ShortcutCategory.VIEWER, "1");
		register ("image.set-zoom('200')", N_("Zoom 200%"), SHORTCUT_CONTEXT_IMAGE, ShortcutCategory.VIEWER, "2");
		register ("image.set-zoom('300')", N_("Zoom 300%"), SHORTCUT_CONTEXT_IMAGE, ShortcutCategory.VIEWER, "3");
		register ("image.set-zoom('max-size')", N_("Zoom to Fit"), SHORTCUT_CONTEXT_IMAGE, ShortcutCategory.VIEWER, "<Shift>x");
		register ("image.set-zoom('max-size-if-larger')", N_("Zoom to Fit if Larger"), SHORTCUT_CONTEXT_IMAGE, ShortcutCategory.VIEWER, "x");
		...
		register ("viewer.revert", N_("Revert to Saved"), ShortcutContext.IMAGE_VIEWER, ShortcutCategory.VIEWER, "F4");
		...
		register ("win.toggle-play", N_("Play/Pause"), ShortcutContext.SLIDESHOW, ShortcutCategory.SLIDESHOW, "space");
		register ("win.next-image", N_("Next File"), ShortcutContext.SLIDESHOW, ShortcutCategory.SLIDESHOW, "Right");
		register ("win.previous-image", N_("Previous File"), ShortcutContext.SLIDESHOW, ShortcutCategory.SLIDESHOW, "Left");
