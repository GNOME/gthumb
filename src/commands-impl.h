...
DEFINE_VERB(edit_folder_view_command_impl);
DEFINE_VERB(edit_folder_view_new_window_command_impl);
...
DEFINE_VERB(edit_folder_copy_command_impl);
DEFINE_VERB(edit_folder_move_command_impl);
DEFINE_VERB(edit_folder_categories_command_impl);
...
DEFINE_VERB(edit_current_folder_copy_command_impl);
DEFINE_VERB(edit_current_folder_move_command_impl);
DEFINE_VERB(edit_current_folder_categories_command_impl);
...
DEFINE_VERB(alter_image_rotate_90_command_impl);
DEFINE_VERB(alter_image_rotate_90_cc_command_impl);
...
DEFINE_VERB(alter_image_crop_command_impl);
