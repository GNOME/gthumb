...
static char *metadata_category_name[GTH_METADATA_CATEGORIES] = { N_("Filesystem Data"), N_("General Info"), N_("Image Data"), N_("Image Taking Conditions"), N_("Maker Notes"), N_("GPS Coordinates"), N_("Embedded Thumbnail"), N_("Other") };
