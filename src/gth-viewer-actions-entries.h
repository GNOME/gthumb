...
static GtkActionEntry gth_viewer_action_entries[] = {
	...
	{ "Edit_EditComment", GTHUMB_STOCK_ADD_COMMENT,
	  ...
	  G_CALLBACK (gth_viewer_activate_action_edit_edit_comment) },

	{ "Edit_EditCategories", GTK_STOCK_INDEX,
	  N_("Ca_tegories"), NULL,
	  N_("Assign categories to selected images"),
	  G_CALLBACK (gth_viewer_activate_action_edit_edit_categories) },

	{ "Edit_DeleteComment", NULL,
	  N_("Rem_ove Comment"), NULL,
	  N_("Remove comments of selected images"),
	  G_CALLBACK (gth_viewer_activate_action_edit_delete_comment) },
...
static guint gth_viewer_n_action_entries = G_N_ELEMENTS (gth_viewer_action_entries);
...
static GtkToggleActionEntry gth_viewer_action_toggle_entries[] = {
	...
	{ "View_PlayAnimation", NULL,
	  ...
	  G_CALLBACK (gth_window_activate_action_view_play_animation), 
	  TRUE },
	{ "View_ShowInfo", NULL,
...
static guint gth_viewer_n_action_toggle_entries = G_N_ELEMENTS (gth_viewer_action_toggle_entries);


static GtkRadioActionEntry gth_viewer_zoom_quality_entries[] = {
...
static guint gth_viewer_n_zoom_quality_entries = G_N_ELEMENTS (gth_viewer_zoom_quality_entries);
