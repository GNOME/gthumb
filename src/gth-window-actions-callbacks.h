...
DEFINE_ACTION(gth_window_activate_action_edit_delete_comment)
...
DEFINE_ACTION(gth_window_activate_action_alter_image_normalize)
DEFINE_ACTION(gth_window_activate_action_alter_image_stretch_contrast)
...
DEFINE_ACTION(gth_window_activate_action_alter_image_threshold)
DEFINE_ACTION(gth_window_activate_action_alter_image_resize)
DEFINE_ACTION(gth_window_activate_action_alter_image_rotate)
